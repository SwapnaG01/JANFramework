...
public class Constants {
	...
	public static final String LOGIN_PAGE_FRACTION_URL ="http://opencart.antropy.co.uk/index.php?route=account/login";
	public static final String ACCOUNTS_PAGE_TITLE ="My Account";
    
	public static final List<String> ACCOUNTS_SECTIONS_LIST=Arrays.asList("My Account","My Orders","Newsletter");
